...
var profile_default = "/assets/profile-DXg0lghS.png";
var cttc_exports = /* @__PURE__ */ __exportAll({ default: () => cttc_default });
var cttc_default = "/assets/cttc-9rxgwZQx.jpg";
var gcp_exports = /* @__PURE__ */ __exportAll({ default: () => gcp_default });
var gcp_default = "/assets/gcp-ClFl03c9.jpg";
var plasticure_exports = /* @__PURE__ */ __exportAll({ default: () => plasticure_default });
var plasticure_default = "data:image/jpeg;base64,";
var pmec_exports = /* @__PURE__ */ __exportAll({ default: () => pmec_default });
var pmec_default = "/assets/pmec-BsxFRlzk.jpg";
var robostreaks_exports = /* @__PURE__ */ __exportAll({ default: () => robostreaks_default });
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -inset-6 rounded-[2.5rem] bg-gradient-primary opacity-20 blur-2xl" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "inline-flex items-center gap-1 rounded-full bg-primary/10 border border-primary/20 px-2.5 py-0.5 text-[10px] font-bold text-primary uppercase tracking-wide",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Brain, { className: "h-3 w-3" }), " AI/ML"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "inline-flex items-center gap-1 rounded-full bg-primary/10 border border-primary/20 px-2.5 py-0.5 text-[10px] font-bold text-primary uppercase tracking-wide",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "h-3 w-3" }), " Vision"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "inline-flex items-center gap-1 rounded-full bg-primary/10 border border-primary/20 px-2.5 py-0.5 text-[10px] font-bold text-primary uppercase tracking-wide",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cloud, { className: "h-3 w-3" }), " Cloud"]
								})
							]
						})]
					})]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					},
					{
						...
						level: "Advanced",
						keywords: ["Preprocessing", "Dimensionality Reduction"],
						icon: BotMessageSquare
					}
				].map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "glass group rounded-2xl p-4.5 transition-all duration-300 hover:-translate-y-1 hover:shadow-glow",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								className: "inline-block mt-0.5 text-[10px] font-semibold text-primary uppercase tracking-wider",
								children: s.level
							})] })]
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-3 flex flex-wrap gap-1.5",
						children: s.keywords.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "rounded-md bg-secondary/60 px-2 py-0.5 text-[10px] font-medium text-muted-foreground transition-colors hover:text-foreground",
							children: k
						}, k))
					})]
				}, s.name))
